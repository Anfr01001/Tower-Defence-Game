...
namespace TowerDefenceGame {
    class Map {
        ...
        public void BuildMap() {
            ...
            StartPoint = new Vector2(tempX, tempY);
            ...
            while (tempY < 15) {
                ...
                EndPoint = new Vector2(tempX, tempY);
            }
            ...
            for (int y = 0; y <= 15; y++) {
                for (int x = 0; x <= 15; x++) {
                    ...
                    //Om de ska vara path skicka med det
                    if (MapArray[x, y] == 1) {
                        path = true;
                    } else {
                        path = false;
                    ...
                    Mapblocklist.Add(new MapBlock(new Vector2(x * 50, y * 50), path));
                }
            }
